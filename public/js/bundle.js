...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHlzb25wIiwiYSI6ImNrcWg2NmVzMTFqMHAyd252OGxtdGZxNHQifQ.hQqZ0Bof_tLCLFbb_9w95w';
  var map = new mapboxgl.Map({
    container: 'map',
    //Id has to be map tp use this container map
    style: 'mapbox://styles/tysonp/ckqh6szle1b6b17o3flf99y6y',
    scrollZoom: false //   center: [-118.339476, 34.01903],
    //   zoom: 8,
    //   interactive: false,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JBo6VIohjXgxaSFxH9PE1jlKqkYJKn469iZZcpVxlaXZyR60tL5xKcqEBSO3Pp2hPoH8zuRYNQ4pOBRwPWcvX0500lxat7i3f'); //1 Get checkout session from API
